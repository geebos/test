...
Object.defineProperty(exports, "__esModule", {
    ...
    return !t || t <= 0 ? 0 : t < 1e4 ? t : t < 1e8 ? (t / 1e4).toFixed(1) + "万" : (t / 1e8).toFixed(1) + "亿";
}, exports.formatSharedNum = function(t) {
    return !t || t < 100 ? 0 : t < 1e4 ? t : t < 1e8 ? (t / 1e4).toFixed(1) + "万" : (t / 1e8).toFixed(1) + "亿";
