...
exports.default = {
    ...
    toSearchResultHandle: function(e) {
        var r = this, s = this.store.getState().searchLayout, c = s.page || "", o = e.detail.value || s.search.keyword || "", i = e.currentTarget.dataset.query || o, u = e.currentTarget.dataset.source || "", h = e.currentTarget.dataset.index || "", d = e.currentTarget.dataset.vfrm || "", n = e.currentTarget.dataset.key || "", l = e.currentTarget.dataset.defaultkey || "", f = e.currentTarget.dataset.rseat || "";
        if (u) {
            if (!i.trim()) {
        ...
        s.search.keyword = i, s.search.pageNum = 1, s.search.source = u, s.search.vfrm = d, 
        s.search.pos = h, t.bind(this)(i, this.store), f && this.clickPingback({
            block: "",
            rseat: "" + f
        ...
        this.setData({
            ...
            url: "/subPackage/pages/searchResult/searchResult?query=" + i + "&rfr=" + r.data.rpage + "&vfrm=" + d + "&key=" + n + "&pos=" + h + "&source=" + u
        }));
    },
    ...
    loadSuggest: function(e, t, r, s) {
        ...
        if (this.suggestCache[e] && this.suggestCache[e].length) {
            ...
            i.length ? (c.suggestCache[e] = i, c.store.dispatch(a.default.showSuggestSearch(i))) : u = {
                defaultSearch: !0,
                suggestSearch: !1,
                suggest: []
            }, c.store.dispatch(a.default.updateSearchState(u));
        }, function() {
            var e = {
                defaultSearch: !0,
                suggestSearch: !1,
    ...
    loadSearchData: function() {
        return new s.default(function(e, t) {
            wx.request({
                ...
                success: function(a) {
                    var r = a.data;
                    r && r.data ? e(o.default.replaceQiyipic(r)) : t(a);
                },
                fail: t
            });
        });
    ...
    loadSuggestList: function(e) {
        return new s.default(function(t, a) {
            wx.request({
                ...
                success: function(e) {
                    var r = e.data;
                    r && r.data ? t(o.default.replaceQiyipic(r)) : a(e);
                },
                fail: a
            });
        });
