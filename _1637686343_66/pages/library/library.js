...
var t = e(require("../../common/pingback/pv")), a = e(require("../../common/pingback/click")), i = e(require("../../common/user/user")), r = e(require("../../common/utils/util")), s = e(require("common/config")), n = e(require("service/commonSearchService")), o = function(e) {
    ...
    loadPage: function(e) {
        e = this.getDefaultChannelId(e), this.store.dispatch(l.default.setData(e)), this.store.dispatch(l.default.initSearchLayout());
    ...
    onShow: function() {
        ...
        a = this.getDefaultChannelId(a), "home" === e && this.onShow.exec && this.switchChannel(null, a);
    },
    onHide: function() {
    ...
    getDefaultChannelId: function(e) {
        return e = [ 2, 1, 6, 4 ].indexOf(e) >= 0 ? e : 2;
    }
};
