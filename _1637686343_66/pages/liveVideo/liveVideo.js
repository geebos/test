...
e(require("../video/common/config"))), v = t(require("../../common/form/subscribeService")), g = t(require("../../common/form/subscribeSession")), m = t(require("./service/liveBroadcast")), b = require("../../common/source/qiyiVideoSource"), S = require("../../common/source/videoConfig"), I = e(require("../../components/homeLead/homeLead")), y = e(require("../../components/mutiAccount/mutiAccount")), V = require("../../vendor/redux/redux"), T = e(require("../../vendor/redux-plugins/reduxTrunk")), q = e(require("./reducers/index")), L = e(require("./actions/index")), w = {
    ...
    subOrUnsubscribe: function(t) {
        ...
        g.getOrSetThirdSession().then(function(n) {
            var s = t.currentTarget.dataset.subscribeStatus, u = t.currentTarget.dataset.subscribeArea, d = 0 == s ? 1 : 0, c = t.currentTarget.dataset.qipuId, l = v.subscribeTypeFunc(c), h = r.data.options.aid, f = r.data.rfr;
            v.liveSubscribe({
                formid: a,
                key: n,
                qipuId: c,
                ...
                e.app.globalData.checkLiveSubscibe = !0;
            }).catch(function(r) {
    ...
    onShareAppMessage: function(t) {
        var e = this.store.getState(), i = e.getLiveStatus, r = e.liveVideoInit.programInfo, a = this.data.options ? this.data.options.qipuId : "";
        if (this.clickPingback({
            block: "",
            rseat: "wx_share",
            aid: a
        }), 1 == i) o = "正在直播：" + r.name; else var o = (0 == i ? "直播预约:" : "") + r.name;
        var n = this.data.options.aid || "", s = this.data.rfr || "", u = r.logo ? r.logo.replace(/_[\d]+_[\d]+(.jpg|bmp|gif)$/, "_480_360$1") : "";
        return {
            title: o,
            path: "/pages/liveVideo/liveVideo?qipuId=" + r.id + "&aid=" + n + "&rfr=" + s,
            imageUrl: u || ""
        };
    },
