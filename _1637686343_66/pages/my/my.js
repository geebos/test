...
require("../../vendor/redux/redux")), h = e(require("../../vendor/redux-plugins/reduxTrunk")), g = e(require("./reducers/index")), f = e(require("./actions/index")), m = {
    ...
    getSearchData: function(e) {
        ...
        d.default.getAllSubscribes(c).then(function(e) {
            return t.store.dispatch(f.default.completeLoad()), {
                results: e.data && e.data.data || []
            };
        }).then(function(a) {
    ...
    _playVideo: function(e) {
        wx.navigateTo({
            url: "/pages/video/video?qipuId=" + e.qipuId + "&id=" + e.id + "&aid=" + e.aid + "&type=" + e.type + "&albumName=" + e.albumName + "&sourceName=" + e.sourceName + "&rfr=wx_pcenter&useRecord=true"
        });
    },
    findmore: function(e) {
...
Page(Object.assign({}, m, s.default, l.default));